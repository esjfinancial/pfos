...
function injectCSS(){
  ...
  style.textContent = ''
    ...
    +'#wt-spotlight{position:absolute;border:2px solid #5B9BFF;border-radius:6px;z-index:100000;pointer-events:none;transition:all .3s ease;box-shadow:0 0 20px rgba(91,155,255,.4),0 0 40px rgba(91,155,255,.15)}'
